...
import org.mandarax.dsl.verification.CheckFreeVariablesInExternalFacts;
import static test.org.mandarax.dsl.TestUtils.*;
/**
 * Test the respective verifier.
 * @author jens dietrich
 */
public class VerifierCheckFreeVariablesInExternalFacts {
	
	@Test (expected=VerificationException.class)
	public void testCompilationUnit1A() throws Exception {
		Verifier verifier = new CheckFreeVariablesInExternalFacts();
		Collection<CompilationUnit> cus = readCUSFromCP("externalfacts1.rel");
