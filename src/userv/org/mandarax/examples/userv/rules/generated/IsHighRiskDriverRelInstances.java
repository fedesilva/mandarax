...
public class IsHighRiskDriverRelInstances {
	...
	// rule: DE_DRC01: _driver.getHasBeenConvictedOfaDUI() ->
	// IsHighRiskDriver(_driver);
	private final static java.util.Properties _annotations_DE_DRC01 = new java.util.Properties();

	// rule: DE_DRC02: (_driver.getNumberOfAccidentsInvolvedIn())>2 ->
	// IsHighRiskDriver(_driver);
	private final static java.util.Properties _annotations_DE_DRC02 = new java.util.Properties();

	// rule: DE_DRC03: (_driver.getNumberOfMovingViolationsInLastTwoYears())>3
	// -> IsHighRiskDriver(_driver);
	private final static java.util.Properties _annotations_DE_DRC03 = new java.util.Properties();

	static {
		// relationship annotations for rule DE_DRC01:
		// _driver.getHasBeenConvictedOfaDUI() -> IsHighRiskDriver(_driver);
		...
		// rule annotations for rule DE_DRC01:
		// _driver.getHasBeenConvictedOfaDUI() -> IsHighRiskDriver(_driver);
		...
		// relationship annotations for rule DE_DRC02:
		// (_driver.getNumberOfAccidentsInvolvedIn())>2 ->
		// IsHighRiskDriver(_driver);
		...
		// rule annotations for rule DE_DRC02:
		// (_driver.getNumberOfAccidentsInvolvedIn())>2 ->
		// IsHighRiskDriver(_driver);
		...
		// relationship annotations for rule DE_DRC03:
		// (_driver.getNumberOfMovingViolationsInLastTwoYears())>3 ->
		// IsHighRiskDriver(_driver);
		...
		// rule annotations for rule DE_DRC03:
		// (_driver.getNumberOfMovingViolationsInLastTwoYears())>3 ->
		// IsHighRiskDriver(_driver);
	...
	private static ResourceIterator<IsHighRiskDriverRel> isHighRiskDriver_0(final DerivationController _derivation, final Driver driver) {
		_derivation.log("IsHighRiskDriver.DE_DRC01", DerivationController.RULE, _annotations_DE_DRC01);
		...
		// case 4
		if (!(_bindings._driver.hasBeenConvictedOfaDUI())) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<IsHighRiskDriverRel> isHighRiskDriver_1(final DerivationController _derivation, final Driver driver) {
		_derivation.log("IsHighRiskDriver.DE_DRC02", DerivationController.RULE, _annotations_DE_DRC02);
		...
		// case 4
		if (!((_bindings._driver.getNumberOfAccidentsInvolvedIn()) > 2)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<IsHighRiskDriverRel> isHighRiskDriver_2(final DerivationController _derivation, final Driver driver) {
		_derivation.log("IsHighRiskDriver.DE_DRC03", DerivationController.RULE, _annotations_DE_DRC03);
		...
		// case 4
		if (!((_bindings._driver.getNumberOfMovingViolationsInLastTwoYears()) > 3)) {
			return EmptyIterator.DEFAULT;
		}
