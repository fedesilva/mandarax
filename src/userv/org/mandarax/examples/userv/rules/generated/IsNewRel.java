...
/**
 * Class representing the relationship <strong>IsNew</strong>. Generated by
...
public class IsNewRel {
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(car, _tmp.car).isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder(17, 37).append(car).toHashCode();
	}

	@Override
	public String toString() {
		return new ToStringBuilder(this).append("car", car).toString();
	}
