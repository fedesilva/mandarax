...
public class PremiumDiscountRelInstances {
	...
	// rule: AD_01: _car.getHasAirbags() & !(_car.getHasFrontPassengerAirbag())
	// & !(_car.getHasSidePanelAirbags()) -> PremiumDiscount(_car,12);
	private final static java.util.Properties _annotations_AD_01 = new java.util.Properties();

	// rule: AD_02: _car.getHasAirbags() & _car.getHasFrontPassengerAirbag() &
	// !(_car.getHasSidePanelAirbags()) -> PremiumDiscount(_car,15);
	private final static java.util.Properties _annotations_AD_02 = new java.util.Properties();

	// rule: AD_03: _car.getHasAirbags() & _car.getHasFrontPassengerAirbag() &
	// _car.getHasSidePanelAirbags() -> PremiumDiscount(_car,18);
	private final static java.util.Properties _annotations_AD_03 = new java.util.Properties();

	// rule: AD_04: PotentialTheftRating(_car,"high") & _car.getHasAlarm() ->
	// PremiumDiscount(_car,10);
	private final static java.util.Properties _annotations_AD_04 = new java.util.Properties();

	static {
		// relationship annotations for rule AD_01: _car.getHasAirbags() &
		...
		// rule annotations for rule AD_02: _car.getHasAirbags() &
		// _car.getHasFrontPassengerAirbag() & !(_car.getHasSidePanelAirbags())
		// -> PremiumDiscount(_car,15);
		_annotations_AD_02.put("description", "If the car has Driver and Passenger airbags then lower the premium by 15%");

		// relationship annotations for rule AD_03: _car.getHasAirbags() &
		// _car.getHasFrontPassengerAirbag() & _car.getHasSidePanelAirbags() ->
		// PremiumDiscount(_car,18);
		...
		// rule annotations for rule AD_03: _car.getHasAirbags() &
		// _car.getHasFrontPassengerAirbag() & _car.getHasSidePanelAirbags() ->
		// PremiumDiscount(_car,18);
		_annotations_AD_03.put("description", "If the car has Driver, Passenger and Side airbags then lower the premium by 18%");

		// relationship annotations for rule AD_04:
		// PotentialTheftRating(_car,"high") & _car.getHasAlarm() ->
		// PremiumDiscount(_car,10);
		...
		// rule annotations for rule AD_04: PotentialTheftRating(_car,"high") &
		// _car.getHasAlarm() -> PremiumDiscount(_car,10);
	...
	private static ResourceIterator<PremiumDiscountRel> getDiscount_0(final DerivationController _derivation, final Car car) {
		_derivation.log("PremiumDiscount.AD_01", DerivationController.RULE, _annotations_AD_01);

		// utility class used to keep track of variables bindings
		// rule: AD_01: _car.getHasAirbags() &
		// !(_car.getHasFrontPassengerAirbag()) &
		// !(_car.getHasSidePanelAirbags()) -> PremiumDiscount(_car,12);
		// prereqs: [_car.getHasAirbags(), !(_car.getHasFrontPassengerAirbag()),
		// !(_car.getHasSidePanelAirbags())]
		class _Bindings {
	...
	private static ResourceIterator<PremiumDiscountRel> getDiscount_1(final DerivationController _derivation, final Car car) {
		_derivation.log("PremiumDiscount.AD_02", DerivationController.RULE, _annotations_AD_02);
	...
	private static ResourceIterator<PremiumDiscountRel> getDiscount_2(final DerivationController _derivation, final Car car) {
		_derivation.log("PremiumDiscount.AD_03", DerivationController.RULE, _annotations_AD_03);
	...
	private static ResourceIterator<PremiumDiscountRel> getDiscount_3(final DerivationController _derivation, final Car car) {
		_derivation.log("PremiumDiscount.AD_04", DerivationController.RULE, _annotations_AD_04);
