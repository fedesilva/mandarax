...
public class AdditionalPremiumRel {
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(policy, _tmp.policy).append(car, _tmp.car).append(premium, _tmp.premium).isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder(17, 37).append(policy).append(car).append(premium).toHashCode();
	}

	@Override
	public String toString() {
		return new ToStringBuilder(this).append("policy", policy).append("car", car).append("premium", premium).toString();
	}
}
