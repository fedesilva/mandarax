...
public class InsuranceEligibilityRelInstances {
	...
	// rule: ES_04: (sum score in
	// PolicyEligibilityScore(_car,_client,score))<100 ->
	// InsuranceEligibility(_car,_client,"eligible");
	private final static java.util.Properties _annotations_ES_04 = new java.util.Properties();

	// rule: ES_05: (sum score in
	// PolicyEligibilityScore(_car,_client,score))>=100 & (sum score in
	// PolicyEligibilityScore(_car,_client,score))<=250 ->
	// InsuranceEligibility(_car,_client,"must be reviewed by underwriting manager");
	private final static java.util.Properties _annotations_ES_05 = new java.util.Properties();

	// rule: ES_06: (sum score in
	// PolicyEligibilityScore(_car,_client,score))>250 ->
	// InsuranceEligibility(_car,_client,"not eligible");
	private final static java.util.Properties _annotations_ES_06 = new java.util.Properties();

	// rule: ES_07: IsLongTermClient(_client) ->
	// InsuranceEligibility(_car,_client,"eligible");
	private final static java.util.Properties _annotations_ES_07 = new java.util.Properties();

	static {
		// relationship annotations for rule ES_04: (sum score in
		// PolicyEligibilityScore(_car,_client,score))<100 ->
		// InsuranceEligibility(_car,_client,"eligible");
		...
		// rule annotations for rule ES_05: (sum score in
		// PolicyEligibilityScore(_car,_client,score))>=100 & (sum score in
		// PolicyEligibilityScore(_car,_client,score))<=250 ->
		// InsuranceEligibility(_car,_client,"must be reviewed by underwriting manager");
		_annotations_ES_05
		...
		// relationship annotations for rule ES_06: (sum score in
		// PolicyEligibilityScore(_car,_client,score))>250 ->
		// InsuranceEligibility(_car,_client,"not eligible");
		...
		// rule annotations for rule ES_06: (sum score in
		// PolicyEligibilityScore(_car,_client,score))>250 ->
		// InsuranceEligibility(_car,_client,"not eligible");
		...
		// relationship annotations for rule ES_07: IsLongTermClient(_client) ->
		// InsuranceEligibility(_car,_client,"eligible");
		...
		// rule annotations for rule ES_07: IsLongTermClient(_client) ->
		// InsuranceEligibility(_car,_client,"eligible");
		_annotations_ES_07.put("description",
	...
	static ResourceIterator<InsuranceEligibilityRel> getEligibility(final DerivationController _derivation, final Car car, final Driver client) {
		...
		return new IteratorChain<InsuranceEligibilityRel>(4) {
			public ResourceIterator<InsuranceEligibilityRel> getNextIterator(int pos) {
				...
				case 2:// invoke ES_06: (sum score in
						// PolicyEligibilityScore(_car,_client,score))>250 ->
						// InsuranceEligibility(_car,_client,"not eligible");
					return getEligibility_2(_derivation.pop(_derivationlevel), car, client);

				case 3:// invoke ES_07: IsLongTermClient(_client) ->
						// InsuranceEligibility(_car,_client,"eligible");
	...
	private static ResourceIterator<InsuranceEligibilityRel> getEligibility_0(final DerivationController _derivation, final Car car, final Driver client) {
		_derivation.log("InsuranceEligibility.ES_04", DerivationController.RULE, _annotations_ES_04);
		...
		// InsuranceEligibility(_car,_client,"eligible");
		// prereqs:
		// [(_sum_0(PolicyEligibilityScoreRelInstances.getScore(_car,_client)))<100]
		class _Bindings {
		...
		// case 4
		if (!((_sum_0(PolicyEligibilityScoreRelInstances.getScore(_bindings._car, _bindings._client))) < 100)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<InsuranceEligibilityRel> getEligibility_1(final DerivationController _derivation, final Car car, final Driver client) {
		_derivation.log("InsuranceEligibility.ES_05", DerivationController.RULE, _annotations_ES_05);
		...
		// InsuranceEligibility(_car,_client,"must be reviewed by underwriting manager");
		// prereqs:
		// [(_sum_1(PolicyEligibilityScoreRelInstances.getScore(_car,_client)))>=100,
		// (_sum_2(PolicyEligibilityScoreRelInstances.getScore(_car,_client)))<=250]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Car _car = car;
			private org.mandarax.examples.userv.domain.Driver _client = client;
			private int score = 0;
		...
		// case 4
		if (!((_sum_1(PolicyEligibilityScoreRelInstances.getScore(_bindings._car, _bindings._client))) >= 100)) {
			return EmptyIterator.DEFAULT;
		}
		...
		// case 4
		if (!((_sum_2(PolicyEligibilityScoreRelInstances.getScore(_bindings._car, _bindings._client))) <= 250)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<InsuranceEligibilityRel> getEligibility_2(final DerivationController _derivation, final Car car, final Driver client) {
		_derivation.log("InsuranceEligibility.ES_06", DerivationController.RULE, _annotations_ES_06);
		...
		// InsuranceEligibility(_car,_client,"not eligible");
		// prereqs:
		// [(_sum_3(PolicyEligibilityScoreRelInstances.getScore(_car,_client)))>250]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Car _car = car;
			private org.mandarax.examples.userv.domain.Driver _client = client;
			private int score = 0;
		...
		// case 4
		if (!((_sum_3(PolicyEligibilityScoreRelInstances.getScore(_bindings._car, _bindings._client))) > 250)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<InsuranceEligibilityRel> getEligibility_3(final DerivationController _derivation, final Car car, final Driver client) {
		_derivation.log("InsuranceEligibility.ES_07", DerivationController.RULE, _annotations_ES_07);
	...
	private static ResourceIterator<InsuranceEligibilityRel> hasEligibility_0(final DerivationController _derivation, final Car car, final Driver client, final String eligibility) {
		...
		// InsuranceEligibility(_car,_client,"eligible");
		// prereqs:
		// [(_sum_4(PolicyEligibilityScoreRelInstances.getScore(_car,_client)))<100]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Car _car = car;
			private org.mandarax.examples.userv.domain.Driver _client = client;
			private int score = 0;
		...
		// case 4
		if (!((_sum_4(PolicyEligibilityScoreRelInstances.getScore(_bindings._car, _bindings._client))) < 100)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<InsuranceEligibilityRel> hasEligibility_1(final DerivationController _derivation, final Car car, final Driver client, final String eligibility) {
		...
		// InsuranceEligibility(_car,_client,"must be reviewed by underwriting manager");
		// prereqs:
		// [(_sum_5(PolicyEligibilityScoreRelInstances.getScore(_car,_client)))>=100,
		// (_sum_6(PolicyEligibilityScoreRelInstances.getScore(_car,_client)))<=250]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Car _car = car;
			private org.mandarax.examples.userv.domain.Driver _client = client;
			private int score = 0;
		...
		// case 4
		if (!((_sum_5(PolicyEligibilityScoreRelInstances.getScore(_bindings._car, _bindings._client))) >= 100)) {
			return EmptyIterator.DEFAULT;
		}
		...
		// case 4
		if (!((_sum_6(PolicyEligibilityScoreRelInstances.getScore(_bindings._car, _bindings._client))) <= 250)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<InsuranceEligibilityRel> hasEligibility_2(final DerivationController _derivation, final Car car, final Driver client, final String eligibility) {
		...
		// InsuranceEligibility(_car,_client,"not eligible");
		// prereqs:
		// [(_sum_7(PolicyEligibilityScoreRelInstances.getScore(_car,_client)))>250]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Car _car = car;
			private org.mandarax.examples.userv.domain.Driver _client = client;
			private int score = 0;
		...
		// case 4
		if (!((_sum_7(PolicyEligibilityScoreRelInstances.getScore(_bindings._car, _bindings._client))) > 250)) {
			return EmptyIterator.DEFAULT;
		}
	...
	// agg _sum_0(PolicyEligibilityScoreRelInstances.getScore(_car,_client))
	// type is sum
	...
	// agg _sum_1(PolicyEligibilityScoreRelInstances.getScore(_car,_client))
	// type is sum
	...
	// agg _sum_2(PolicyEligibilityScoreRelInstances.getScore(_car,_client))
	// type is sum
	...
	// agg _sum_3(PolicyEligibilityScoreRelInstances.getScore(_car,_client))
	// type is sum
	...
	// agg _sum_4(PolicyEligibilityScoreRelInstances.getScore(_car,_client))
	// type is sum
	...
	// agg _sum_5(PolicyEligibilityScoreRelInstances.getScore(_car,_client))
	// type is sum
	...
	// agg _sum_6(PolicyEligibilityScoreRelInstances.getScore(_car,_client))
	// type is sum
	...
	// agg _sum_7(PolicyEligibilityScoreRelInstances.getScore(_car,_client))
	// type is sum
