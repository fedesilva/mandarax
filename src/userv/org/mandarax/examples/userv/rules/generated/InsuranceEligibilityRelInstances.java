	...
	static ResourceIterator<InsuranceEligibilityRel> getEligibility(final DerivationController _derivation, final Car car, final Driver client) {
		...
		return new IteratorChain<InsuranceEligibilityRel>(4) {
			...
			public ResourceIterator<InsuranceEligibilityRel> getNextIterator(int pos) {
				...
				case 1: {
					// invoke ES_05: (sum score in
					// PolicyEligibilityScore(_car,_client,score))>=100 & (sum
					// score in PolicyEligibilityScore(_car,_client,score))<=250
					// ->
					// InsuranceEligibility(_car,_client,"must be reviewed by underwriting manager");
				...
				case 3: {
					// invoke ES_07: IsLongTermClient(_client) ->
					// InsuranceEligibility(_car,_client,"eligible");
