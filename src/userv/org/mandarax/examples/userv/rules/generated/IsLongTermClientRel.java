...
public class IsLongTermClientRel {
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(client, _tmp.client).isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder(17, 37).append(client).toHashCode();
	}

	@Override
	public String toString() {
		return new ToStringBuilder(this).append("client", client).toString();
	}
}
