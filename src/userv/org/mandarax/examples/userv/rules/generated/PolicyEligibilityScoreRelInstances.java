 ...
 * <strong>PolicyEligibilityScore</strong>. Generated by
...
public class PolicyEligibilityScoreRelInstances {
	...
	static {
		...
		// rule annotations for rule ES_01b: AutoEligibility(_car,"provisional")
		// -> PolicyEligibilityScore(_car,_driver,50);
		_annotations_ES_01b.put("description", "If car is Provisional then increase policy eligibility score by 50");

		// relationship annotations for rule ES_02a:
		// DriverCategory(_driver,"young driver") & not IsEligible(_driver) ->
		// PolicyEligibilityScore(_car,_driver,30);
		...
		// rule annotations for rule ES_02a:
		// DriverCategory(_driver,"young driver") & not IsEligible(_driver) ->
		// PolicyEligibilityScore(_car,_driver,30);

		// relationship annotations for rule ES_02b:
		// DriverCategory(_driver,"senior driver") & not IsEligible(_driver) ->
		// PolicyEligibilityScore(_car,_driver,20);
		...
		// rule annotations for rule ES_02b:
		// DriverCategory(_driver,"senior driver") & not IsEligible(_driver) ->
		// PolicyEligibilityScore(_car,_driver,20);

		// relationship annotations for rule ES_02c: IsHighRiskDriver(_driver)
		// -> PolicyEligibilityScore(_car,_driver,100);
		...
		// rule annotations for rule ES_02c: IsHighRiskDriver(_driver) ->
		// PolicyEligibilityScore(_car,_driver,100);
		_annotations_ES_02c.put("description", "If driver is High Risk Driver then increase policy eligibility score by 100");

		// relationship annotations for rule ES_03a: client.getIsPreferred() ->
		// PolicyEligibilityScore(_car,client,-50);
		...
		// rule annotations for rule ES_03a: client.getIsPreferred() ->
		// PolicyEligibilityScore(_car,client,-50);
		_annotations_ES_03a.put("description", "If client is Preferred then reduce policy eligibility score by 50");

		// relationship annotations for rule ES_03b: client.getIsElite() ->
		// PolicyEligibilityScore(_car,client,-100);
		...
		// rule annotations for rule ES_03b: client.getIsElite() ->
		// PolicyEligibilityScore(_car,client,-100);
	...
	static ResourceIterator<PolicyEligibilityScoreRel> getScore(final DerivationController _derivation, final Car car, final Driver driver) {
		...
		return new IteratorChain<PolicyEligibilityScoreRel>(7) {
			public ResourceIterator<PolicyEligibilityScoreRel> getNextIterator(int pos) {
				switch (pos) {
				case 0:// invoke ES_01a: AutoEligibility(_car,"not eligible") ->
						// PolicyEligibilityScore(_car,_driver,100);
					return getScore_0(_derivation.pop(_derivationlevel), car, driver);

				case 1:// invoke ES_01b: AutoEligibility(_car,"provisional") ->
						// PolicyEligibilityScore(_car,_driver,50);
					return getScore_1(_derivation.pop(_derivationlevel), car, driver);

				case 2:// invoke ES_02a: DriverCategory(_driver,"young driver")
						// & not IsEligible(_driver) ->
						// PolicyEligibilityScore(_car,_driver,30);
					return getScore_2(_derivation.pop(_derivationlevel), car, driver);

				case 3:// invoke ES_02b: DriverCategory(_driver,"senior driver")
						// & not IsEligible(_driver) ->
						// PolicyEligibilityScore(_car,_driver,20);
					return getScore_3(_derivation.pop(_derivationlevel), car, driver);

				case 4:// invoke ES_02c: IsHighRiskDriver(_driver) ->
						// PolicyEligibilityScore(_car,_driver,100);
					return getScore_4(_derivation.pop(_derivationlevel), car, driver);

				case 5:// invoke ES_03a: client.getIsPreferred() ->
						// PolicyEligibilityScore(_car,client,-50);
					return getScore_5(_derivation.pop(_derivationlevel), car, driver);

				case 6:// invoke ES_03b: client.getIsElite() ->
						// PolicyEligibilityScore(_car,client,-100);
	...
	private static ResourceIterator<PolicyEligibilityScoreRel> getScore_2(final DerivationController _derivation, final Car car, final Driver driver) {
		...
		// rule: ES_02a: DriverCategory(_driver,"young driver") & not
		// IsEligible(_driver) -> PolicyEligibilityScore(_car,_driver,30);
		// prereqs: [DriverCategory(_driver,"young driver"), not
		// IsEligible(_driver)]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Car _car = car;
			private org.mandarax.examples.userv.domain.Driver _driver = driver;
