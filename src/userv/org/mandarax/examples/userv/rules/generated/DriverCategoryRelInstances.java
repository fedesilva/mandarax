	...
	static ResourceIterator<DriverCategoryRel> getCategory(final DerivationController _derivation, final Driver driver) {
		...
		return new IteratorChain<DriverCategoryRel>(4) {
			...
			public ResourceIterator<DriverCategoryRel> getNextIterator(int pos) {
				...
				case 0: {
					// invoke DE_DAC01: _driver.getIsMale() &
					// (_driver.getAge())<25 ->
					// DriverCategory(_driver,"young driver");
				...
				case 1: {
					// invoke DE_DAC02: !(_driver.getIsMale()) &
					// (_driver.getAge())<20 ->
					// DriverCategory(_driver,"young driver");
				...
				case 2: {
					// invoke DE_DAC04: (_driver.getAge())>70 ->
					// DriverCategory(_driver,"senior driver");
					return getCategory_2(_derivation.pop(_derivationlevel), driver);
				}

				case 3: {
					// invoke DP_07: not DriverCategory(_driver,"young driver")
					// & not DriverCategory(_driver,"senior driver") ->
					// DriverCategory(_driver,"typical driver");
