...
public class DriverCategoryRelInstances {
	...
	// rule: DE_DAC01: _driver.getIsMale() & (_driver.getAge())<25 ->
	...
	// rule: DP_07: not DriverCategory(_driver,"young driver") & not
	// DriverCategory(_driver,"senior driver") ->
	// DriverCategory(_driver,"typical driver");
	private final static java.util.Properties _annotations_DP_07 = new java.util.Properties();

	static {
		// relationship annotations for rule DE_DAC01: _driver.getIsMale() &
		// (_driver.getAge())<25 -> DriverCategory(_driver,"young driver");
		...
		// rule annotations for rule DE_DAC01: _driver.getIsMale() &
		// (_driver.getAge())<25 -> DriverCategory(_driver,"young driver");
		_annotations_DE_DAC01.put("description", "If the driver is male and is under the age of 25, then young driver");

		// relationship annotations for rule DE_DAC02: !(_driver.getIsMale()) &
		// (_driver.getAge())<20 -> DriverCategory(_driver,"young driver");
		...
		// rule annotations for rule DE_DAC02: !(_driver.getIsMale()) &
		// (_driver.getAge())<20 -> DriverCategory(_driver,"young driver");
		_annotations_DE_DAC02.put("description", "If the driver is female and is under the age of 20, then young driver");

		// relationship annotations for rule DE_DAC04: (_driver.getAge())>70 ->
		// DriverCategory(_driver,"senior driver");
		...
		// rule annotations for rule DE_DAC04: (_driver.getAge())>70 ->
		// DriverCategory(_driver,"senior driver");
		_annotations_DE_DAC04.put("description", "If the driver is over the age of 70, then senior driver");

		// relationship annotations for rule DP_07: not
		...
		// rule annotations for rule DP_07: not
		// DriverCategory(_driver,"young driver") & not
		// DriverCategory(_driver,"senior driver") ->
		// DriverCategory(_driver,"typical driver");
	}
	...
	private static ResourceIterator<DriverCategoryRel> getCategory_0(final DerivationController _derivation, final Driver driver) {
		_derivation.log("DriverCategory.DE_DAC01", DerivationController.RULE, _annotations_DE_DAC01);
		...
		// case 4
		if (!((_bindings._driver.getAge()) < 25)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<DriverCategoryRel> getCategory_1(final DerivationController _derivation, final Driver driver) {
		_derivation.log("DriverCategory.DE_DAC02", DerivationController.RULE, _annotations_DE_DAC02);
		...
		// case 4
		if (!((_bindings._driver.getAge()) < 20)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<DriverCategoryRel> getCategory_2(final DerivationController _derivation, final Driver driver) {
		_derivation.log("DriverCategory.DE_DAC04", DerivationController.RULE, _annotations_DE_DAC04);
		...
		// case 4
		if (!((_bindings._driver.getAge()) > 70)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<DriverCategoryRel> getCategory_3(final DerivationController _derivation, final Driver driver) {
		_derivation.log("DriverCategory.DP_07", DerivationController.RULE, _annotations_DP_07);

		// utility class used to keep track of variables bindings
		// rule: DP_07: not DriverCategory(_driver,"young driver") & not
		// DriverCategory(_driver,"senior driver") ->
		// DriverCategory(_driver,"typical driver");
		// prereqs: [not DriverCategory(_driver,"young driver"), not
		// DriverCategory(_driver,"senior driver")]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Driver _driver = driver;
		}
