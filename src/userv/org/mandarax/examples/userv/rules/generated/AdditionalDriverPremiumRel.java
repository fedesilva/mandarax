 ...
 * 
 * @version Nov 22, 2010 2:53:24 PM
 */
public class AdditionalDriverPremiumRel {
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(driver, _tmp.driver).append(premium, _tmp.premium).isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder(17, 37).append(driver).append(premium).toHashCode();
	}

	@Override
	public String toString() {
		return new ToStringBuilder(this).append("driver", driver).append("premium", premium).toString();
	}
}
