 ...
 * <strong>HasTrainingCertification</strong>. Generated by
...
public class HasTrainingCertificationRelInstances {
	...
	static {
		...
		// rule annotations for rule DE_DAC07:
		// _driver.getHasDriversTrainingFromSchool() ->
		// HasTrainingCertification(_driver);
		...
		// relationship annotations for rule DE_DAC08:
		// _driver.getHasDriversTrainingFromLicensedDriverTrainingCompany() ->
		// HasTrainingCertification(_driver);
		...
		// rule annotations for rule DE_DAC08:
		// _driver.getHasDriversTrainingFromLicensedDriverTrainingCompany() ->
		// HasTrainingCertification(_driver);
		...
		// relationship annotations for rule DE_DAC09:
		// _driver.getHasTakenASeniorCitizenDriversRefresherCourse() ->
		// HasTrainingCertification(_driver);
		...
		// rule annotations for rule DE_DAC09:
		// _driver.getHasTakenASeniorCitizenDriversRefresherCourse() ->
		// HasTrainingCertification(_driver);
	...
	private static ResourceIterator<HasTrainingCertificationRel> hasDertification_0(final DerivationController _derivation, final Driver driver) {
		...
		// case 4
		if (!(_bindings._driver.hasDriversTrainingFromSchool())) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<HasTrainingCertificationRel> hasDertification_1(final DerivationController _derivation, final Driver driver) {
		...
		// case 4
		if (!(_bindings._driver.hasDriversTrainingFromLicensedDriverTrainingCompany())) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<HasTrainingCertificationRel> hasDertification_2(final DerivationController _derivation, final Driver driver) {
		...
		// case 4
		if (!(_bindings._driver.hasTakenASeniorCitizenDriversRefresherCourse())) {
			return EmptyIterator.DEFAULT;
		}
