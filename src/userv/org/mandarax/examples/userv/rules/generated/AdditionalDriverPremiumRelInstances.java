...
/**
 * Interface for queries for relationship
 * <strong>AdditionalDriverPremium</strong>. Generated by
...
public class AdditionalDriverPremiumRelInstances {
	...
	// rule: DP_01: DriverCategory(_driver,"young driver") &
	// _driver.getIsMarried() & IsSpecialLocation(_driver) ->
	// AdditionalDriverPremium(_driver,700);
	private final static java.util.Properties _annotations_DP_01 = new java.util.Properties();

	// rule: DP_02: DriverCategory(_driver,"young driver") &
	// !(_driver.getIsMarried()) & IsSpecialLocation(_driver) ->
	// AdditionalDriverPremium(_driver,720);
	private final static java.util.Properties _annotations_DP_02 = new java.util.Properties();

	// rule: DP_03: DriverCategory(_driver,"young driver") &
	// _driver.getIsMarried() & not IsSpecialLocation(_driver) ->
	// AdditionalDriverPremium(_driver,300);
	private final static java.util.Properties _annotations_DP_03 = new java.util.Properties();

	// rule: DP_04: DriverCategory(_driver,"young driver") &
	// !(_driver.getIsMarried()) & not IsSpecialLocation(_driver) ->
	// AdditionalDriverPremium(_driver,300);
	private final static java.util.Properties _annotations_DP_04 = new java.util.Properties();

	// rule: DP_05: DriverCategory(_driver,"senior driver") &
	// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,500);
	private final static java.util.Properties _annotations_DP_05 = new java.util.Properties();

	// rule: DP_06: DriverCategory(_driver,"senior driver") & not
	// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,200);
	private final static java.util.Properties _annotations_DP_06 = new java.util.Properties();

	// rule: DP_08: IsHighRiskDriver(_driver) ->
	// AdditionalDriverPremium(_driver,1000);
	private final static java.util.Properties _annotations_DP_08 = new java.util.Properties();

	// rule: DP_09: (_driver.getNumberOfAccidentsInvolvedIn())>0 ->
	// AdditionalDriverPremium(_driver,150*(_driver.getNumberOfAccidentsInvolvedIn()));
	private final static java.util.Properties _annotations_DP_09 = new java.util.Properties();

	// rule: MSD_01: client.getIsPreferred() ->
	// AdditionalDriverPremium(client,-250);
	private final static java.util.Properties _annotations_MSD_01 = new java.util.Properties();

	// rule: MSD_02: client.getIsElite() ->
	// AdditionalDriverPremium(client,-500);
	private final static java.util.Properties _annotations_MSD_02 = new java.util.Properties();

	static {
		// relationship annotations for rule DP_01:
		// DriverCategory(_driver,"young driver") & _driver.getIsMarried() &
		// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,700);
		...
		// rule annotations for rule DP_01:
		// DriverCategory(_driver,"young driver") & _driver.getIsMarried() &
		// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,700);
		_annotations_DP_01.put("description", "If young driver and married and located in CA, NY or VA, then increase premium by $700");

		// relationship annotations for rule DP_02:
		// DriverCategory(_driver,"young driver") & !(_driver.getIsMarried()) &
		// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,720);
		...
		// rule annotations for rule DP_02:
		// DriverCategory(_driver,"young driver") & !(_driver.getIsMarried()) &
		// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,720);
		_annotations_DP_02.put("description", "If young driver and single and located in CA, NY or VA, then increase premium by $720");

		// relationship annotations for rule DP_03:
		// DriverCategory(_driver,"young driver") & _driver.getIsMarried() & not
		// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,300);
		...
		// rule annotations for rule DP_03:
		// DriverCategory(_driver,"young driver") & _driver.getIsMarried() & not
		// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,300);

		// relationship annotations for rule DP_04:
		// DriverCategory(_driver,"young driver") & !(_driver.getIsMarried()) &
		// not IsSpecialLocation(_driver) ->
		// AdditionalDriverPremium(_driver,300);
		...
		// rule annotations for rule DP_04:
		// DriverCategory(_driver,"young driver") & !(_driver.getIsMarried()) &
		// not IsSpecialLocation(_driver) ->
		// AdditionalDriverPremium(_driver,300);

		// relationship annotations for rule DP_05:
		// DriverCategory(_driver,"senior driver") & IsSpecialLocation(_driver)
		// -> AdditionalDriverPremium(_driver,500);
		...
		// rule annotations for rule DP_06:
		// DriverCategory(_driver,"senior driver") & not
		// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,200);

		// relationship annotations for rule DP_08: IsHighRiskDriver(_driver) ->
		// AdditionalDriverPremium(_driver,1000);
		...
		// rule annotations for rule DP_08: IsHighRiskDriver(_driver) ->
		// AdditionalDriverPremium(_driver,1000);
		_annotations_DP_08.put("description", "If a High Risk Driver, then increase premium by $1,000");

		// relationship annotations for rule DP_09:
		// (_driver.getNumberOfAccidentsInvolvedIn())>0 ->
		// AdditionalDriverPremium(_driver,150*(_driver.getNumberOfAccidentsInvolvedIn()));
		...
		// rule annotations for rule DP_09:
		// (_driver.getNumberOfAccidentsInvolvedIn())>0 ->
		// AdditionalDriverPremium(_driver,150*(_driver.getNumberOfAccidentsInvolvedIn()));
		_annotations_DP_09.put("description", "Raise the premium by $ 150 per accident");

		// relationship annotations for rule MSD_01: client.getIsPreferred() ->
		// AdditionalDriverPremium(client,-250);
		...
		// rule annotations for rule MSD_01: client.getIsPreferred() ->
		// AdditionalDriverPremium(client,-250);
		...
		// relationship annotations for rule MSD_02: client.getIsElite() ->
		// AdditionalDriverPremium(client,-500);
		...
		// rule annotations for rule MSD_02: client.getIsElite() ->
		// AdditionalDriverPremium(client,-500);
	...
	static ResourceIterator<AdditionalDriverPremiumRel> getPremium(final DerivationController _derivation, final Driver driver) {
		...
		return new IteratorChain<AdditionalDriverPremiumRel>(10) {
			public ResourceIterator<AdditionalDriverPremiumRel> getNextIterator(int pos) {
				switch (pos) {
				case 0:// invoke DP_01: DriverCategory(_driver,"young driver") &
						// _driver.getIsMarried() & IsSpecialLocation(_driver)
						// -> AdditionalDriverPremium(_driver,700);
					return getPremium_0(_derivation.pop(_derivationlevel), driver);

				case 1:// invoke DP_02: DriverCategory(_driver,"young driver") &
						// !(_driver.getIsMarried()) &
						// IsSpecialLocation(_driver) ->
						// AdditionalDriverPremium(_driver,720);
					return getPremium_1(_derivation.pop(_derivationlevel), driver);

				case 2:// invoke DP_03: DriverCategory(_driver,"young driver") &
						// _driver.getIsMarried() & not
						// IsSpecialLocation(_driver) ->
						// AdditionalDriverPremium(_driver,300);
					return getPremium_2(_derivation.pop(_derivationlevel), driver);

				case 3:// invoke DP_04: DriverCategory(_driver,"young driver") &
						// !(_driver.getIsMarried()) & not
						// IsSpecialLocation(_driver) ->
						// AdditionalDriverPremium(_driver,300);
					return getPremium_3(_derivation.pop(_derivationlevel), driver);

				case 4:// invoke DP_05: DriverCategory(_driver,"senior driver")
						// & IsSpecialLocation(_driver) ->
						// AdditionalDriverPremium(_driver,500);
					return getPremium_4(_derivation.pop(_derivationlevel), driver);

				case 5:// invoke DP_06: DriverCategory(_driver,"senior driver")
						// & not IsSpecialLocation(_driver) ->
						// AdditionalDriverPremium(_driver,200);
					return getPremium_5(_derivation.pop(_derivationlevel), driver);

				case 6:// invoke DP_08: IsHighRiskDriver(_driver) ->
						// AdditionalDriverPremium(_driver,1000);
				...
				case 8:// invoke MSD_01: client.getIsPreferred() ->
						// AdditionalDriverPremium(client,-250);
					return getPremium_8(_derivation.pop(_derivationlevel), driver);

				case 9:// invoke MSD_02: client.getIsElite() ->
						// AdditionalDriverPremium(client,-500);
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_0(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.DP_01", DerivationController.RULE, _annotations_DP_01);

		// utility class used to keep track of variables bindings
		// rule: DP_01: DriverCategory(_driver,"young driver") &
		// _driver.getIsMarried() & IsSpecialLocation(_driver) ->
		// AdditionalDriverPremium(_driver,700);
		// prereqs: [_driver.getIsMarried(),
		// DriverCategory(_driver,"young driver"), IsSpecialLocation(_driver)]
		class _Bindings {
		...
		// case 4
		if (!(_bindings._driver.isMarried())) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_1(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.DP_02", DerivationController.RULE, _annotations_DP_02);
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_2(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.DP_03", DerivationController.RULE, _annotations_DP_03);
		...
		// AdditionalDriverPremium(_driver,300);
		// prereqs: [_driver.getIsMarried(),
		// DriverCategory(_driver,"young driver"), not
		// IsSpecialLocation(_driver)]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Driver _driver = driver;
		}
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_3(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.DP_04", DerivationController.RULE, _annotations_DP_04);
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_4(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.DP_05", DerivationController.RULE, _annotations_DP_05);
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_5(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.DP_06", DerivationController.RULE, _annotations_DP_06);

		// utility class used to keep track of variables bindings
		// rule: DP_06: DriverCategory(_driver,"senior driver") & not
		// IsSpecialLocation(_driver) -> AdditionalDriverPremium(_driver,200);
		// prereqs: [DriverCategory(_driver,"senior driver"), not
		// IsSpecialLocation(_driver)]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Driver _driver = driver;
		}
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_6(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.DP_08", DerivationController.RULE, _annotations_DP_08);
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_7(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.DP_09", DerivationController.RULE, _annotations_DP_09);
		...
		// case 4
		if (!((_bindings._driver.getNumberOfAccidentsInvolvedIn()) > 0)) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_8(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.MSD_01", DerivationController.RULE, _annotations_MSD_01);
		...
		// case 4
		if (!(_bindings.client.isPreferred())) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> getPremium_9(final DerivationController _derivation, final Driver driver) {
		_derivation.log("AdditionalDriverPremium.MSD_02", DerivationController.RULE, _annotations_MSD_02);
	...
	private static ResourceIterator<AdditionalDriverPremiumRel> hasPremium_7(final DerivationController _derivation, final Driver driver, final int premium) {
		...
		// utility class used to keep track of variables bindings
		// rule: DP_09: (_driver.getNumberOfAccidentsInvolvedIn())>0 &
		// __t0==(150*(_driver.getNumberOfAccidentsInvolvedIn())) ->
		// AdditionalDriverPremium(_driver,__t0);
		// prereqs: [(_driver.getNumberOfAccidentsInvolvedIn())>0,
		// __t0==(150*(_driver.getNumberOfAccidentsInvolvedIn()))]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Driver _driver = driver;
		...
		// case 4
		if (!(org.mandarax.rt.Equals.compare(_bindings.__t0, 150 * (_bindings._driver.getNumberOfAccidentsInvolvedIn())))) {
			return EmptyIterator.DEFAULT;
		}
