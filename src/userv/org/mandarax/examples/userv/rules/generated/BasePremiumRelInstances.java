...
public class BasePremiumRelInstances {
	...
	static {
		// relationship annotations for rule AP_01: _car.getIsCompact() ->
		// BasePremium(_car,250);
		...
		// rule annotations for rule AP_01: _car.getIsCompact() ->
		// BasePremium(_car,250);
		_annotations_AP_01.put("description", "If compact car, then base premium is $250");

		// relationship annotations for rule AP_02: _car.getIsSedan() ->
		// BasePremium(_car,400);
		...
		// rule annotations for rule AP_02: _car.getIsSedan() ->
		// BasePremium(_car,400);
		_annotations_AP_02.put("description", "If sedan, then base premium is $400");

		// relationship annotations for rule AP_03: _car.getIsLuxury() ->
		// BasePremium(_car,500);
		...
		// rule annotations for rule AP_03: _car.getIsLuxury() ->
		// BasePremium(_car,500);
	...
	private static ResourceIterator<BasePremiumRel> getPremium_0(final DerivationController _derivation, final Car car) {
		_derivation.log("BasePremium.AP_01", DerivationController.RULE, _annotations_AP_01);
	...
	private static ResourceIterator<BasePremiumRel> getPremium_1(final DerivationController _derivation, final Car car) {
		_derivation.log("BasePremium.AP_02", DerivationController.RULE, _annotations_AP_02);
	...
	private static ResourceIterator<BasePremiumRel> getPremium_2(final DerivationController _derivation, final Car car) {
		_derivation.log("BasePremium.AP_03", DerivationController.RULE, _annotations_AP_03);
