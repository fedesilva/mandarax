...
public class AdditionalPremiumRelInstances {
	...
	static {
		...
		// rule annotations for rule AP_04: IsNew(_car) ->
		// AdditionalPremium(_policy,_car,400);
		_annotations_AP_04.put("description", "If car is new, then increase premium by $400");

		// relationship annotations for rule AP_07: (_car.getAge())<5 & not
		// IsNew(_car) -> AdditionalPremium(_policy,_car,300);
		...
		// rule annotations for rule AP_07: (_car.getAge())<5 & not IsNew(_car)
		// -> AdditionalPremium(_policy,_car,300);

		// relationship annotations for rule AP_08: (_car.getAge())>=5 &
		// (_car.getAge())<=10 -> AdditionalPremium(_policy,_car,250);
		...
		// rule annotations for rule AP_08: (_car.getAge())>=5 &
		// (_car.getAge())<=10 -> AdditionalPremium(_policy,_car,250);
		_annotations_AP_08.put("description", "If car is between 5 and 10 years old, then increase premium by $250");

		// relationship annotations for rule AP_09:
		// _policy.getIncludesUninsuredMotoristCoverage() ->
		// AdditionalPremium(_policy,_car,300);
		...
		// rule annotations for rule AP_10: _policy.getIncludesMedicalCoverage()
		// -> AdditionalPremium(_policy,_car,600);
		_annotations_AP_10.put("description", "If medical coverage is included, then increase premium by $600");

		// relationship annotations for rule AP_11:
		...
		// rule annotations for rule AP_13: PotentialTheftRating(_car,"high") ->
		// AdditionalPremium(_policy,_car,500);
	...
	static ResourceIterator<AdditionalPremiumRel> getPremium(final DerivationController _derivation, final Policy policy, final Car car) {
		...
		return new IteratorChain<AdditionalPremiumRel>(8) {
			public ResourceIterator<AdditionalPremiumRel> getNextIterator(int pos) {
				switch (pos) {
				case 0:// invoke AP_04: IsNew(_car) ->
						// AdditionalPremium(_policy,_car,400);
					return getPremium_0(_derivation.pop(_derivationlevel), policy, car);

				case 1:// invoke AP_07: (_car.getAge())<5 & not IsNew(_car) ->
						// AdditionalPremium(_policy,_car,300);
					return getPremium_1(_derivation.pop(_derivationlevel), policy, car);

				case 2:// invoke AP_08: (_car.getAge())>=5 & (_car.getAge())<=10
						// -> AdditionalPremium(_policy,_car,250);
				...
				case 4:// invoke AP_10: _policy.getIncludesMedicalCoverage() ->
						// AdditionalPremium(_policy,_car,600);
				...
				case 7:// invoke AP_13: PotentialTheftRating(_car,"high") ->
						// AdditionalPremium(_policy,_car,500);
	...
	private static ResourceIterator<AdditionalPremiumRel> getPremium_0(final DerivationController _derivation, final Policy policy, final Car car) {
		_derivation.log("AdditionalPremium.AP_04", DerivationController.RULE, _annotations_AP_04);
	...
	private static ResourceIterator<AdditionalPremiumRel> getPremium_1(final DerivationController _derivation, final Policy policy, final Car car) {
		_derivation.log("AdditionalPremium.AP_07", DerivationController.RULE, _annotations_AP_07);
	...
	private static ResourceIterator<AdditionalPremiumRel> getPremium_2(final DerivationController _derivation, final Policy policy, final Car car) {
		_derivation.log("AdditionalPremium.AP_08", DerivationController.RULE, _annotations_AP_08);
	...
	private static ResourceIterator<AdditionalPremiumRel> getPremium_3(final DerivationController _derivation, final Policy policy, final Car car) {
		_derivation.log("AdditionalPremium.AP_09", DerivationController.RULE, _annotations_AP_09);
		...
		// case 4
		if (!(_bindings._policy.includesUninsuredMotoristCoverage())) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<AdditionalPremiumRel> getPremium_4(final DerivationController _derivation, final Policy policy, final Car car) {
		_derivation.log("AdditionalPremium.AP_10", DerivationController.RULE, _annotations_AP_10);
		...
		// case 4
		if (!(_bindings._policy.includesMedicalCoverage())) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<AdditionalPremiumRel> getPremium_5(final DerivationController _derivation, final Policy policy, final Car car) {
		_derivation.log("AdditionalPremium.AP_11", DerivationController.RULE, _annotations_AP_11);
	...
	private static ResourceIterator<AdditionalPremiumRel> getPremium_6(final DerivationController _derivation, final Policy policy, final Car car) {
		_derivation.log("AdditionalPremium.AP_12", DerivationController.RULE, _annotations_AP_12);
	...
	private static ResourceIterator<AdditionalPremiumRel> getPremium_7(final DerivationController _derivation, final Policy policy, final Car car) {
		_derivation.log("AdditionalPremium.AP_13", DerivationController.RULE, _annotations_AP_13);
