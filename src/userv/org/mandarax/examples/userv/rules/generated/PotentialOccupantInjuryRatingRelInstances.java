 ...
 * <strong>PotentialOccupantInjuryRating</strong>. Generated by
...
public class PotentialOccupantInjuryRatingRelInstances {
	...
	// rule: AE_POIC01: !(_car.getHasAirbags()) ->
	...
	// rule: AE_POIC02: _car.getHasDriversAirbag() &
	// !(_car.getHasFrontPassengerAirbag()) & !(_car.getHasSidePanelAirbags())
	...
	// rule: AE_POIC03: _car.getHasDriversAirbag() &
	// _car.getHasFrontPassengerAirbag() & !(_car.getHasSidePanelAirbags()) ->
	// PotentialOccupantInjuryRating(_car,"moderate");
	private final static java.util.Properties _annotations_AE_POIC03 = new java.util.Properties();

	// rule: AE_POIC04: _car.getHasDriversAirbag() &
	// _car.getHasFrontPassengerAirbag() & _car.getHasSidePanelAirbags() ->
	// PotentialOccupantInjuryRating(_car,"low");
	private final static java.util.Properties _annotations_AE_POIC04 = new java.util.Properties();

	// rule: AE_POIC05: _car.getIsConvertible() & !(_car.getHasRollBar()) ->
	// PotentialOccupantInjuryRating(_car,"extremely high");
	private final static java.util.Properties _annotations_AE_POIC05 = new java.util.Properties();

	static {
		// relationship annotations for rule AE_POIC01: !(_car.getHasAirbags())
		// -> PotentialOccupantInjuryRating(_car,"extremely high");
		...
		// rule annotations for rule AE_POIC01: !(_car.getHasAirbags()) ->
		// PotentialOccupantInjuryRating(_car,"extremely high");
		...
		// relationship annotations for rule AE_POIC02:
		// _car.getHasDriversAirbag() & !(_car.getHasFrontPassengerAirbag()) &
		// !(_car.getHasSidePanelAirbags()) ->
		// PotentialOccupantInjuryRating(_car,"high");
		...
		// rule annotations for rule AE_POIC02: _car.getHasDriversAirbag() &
		// !(_car.getHasFrontPassengerAirbag()) &
		// !(_car.getHasSidePanelAirbags()) ->
		// PotentialOccupantInjuryRating(_car,"high");
		...
		// relationship annotations for rule AE_POIC03:
		// _car.getHasDriversAirbag() & _car.getHasFrontPassengerAirbag() &
		// !(_car.getHasSidePanelAirbags()) ->
		// PotentialOccupantInjuryRating(_car,"moderate");
		...
		// rule annotations for rule AE_POIC03: _car.getHasDriversAirbag() &
		// _car.getHasFrontPassengerAirbag() & !(_car.getHasSidePanelAirbags())
		// -> PotentialOccupantInjuryRating(_car,"moderate");
		...
		// relationship annotations for rule AE_POIC04:
		// _car.getHasDriversAirbag() & _car.getHasFrontPassengerAirbag() &
		// _car.getHasSidePanelAirbags() ->
		// PotentialOccupantInjuryRating(_car,"low");
		...
		// rule annotations for rule AE_POIC04: _car.getHasDriversAirbag() &
		// _car.getHasFrontPassengerAirbag() & _car.getHasSidePanelAirbags() ->
		// PotentialOccupantInjuryRating(_car,"low");
		...
		// relationship annotations for rule AE_POIC05: _car.getIsConvertible()
		// & !(_car.getHasRollBar()) ->
		// PotentialOccupantInjuryRating(_car,"extremely high");
		...
		// rule annotations for rule AE_POIC05: _car.getIsConvertible() &
		// !(_car.getHasRollBar()) ->
		// PotentialOccupantInjuryRating(_car,"extremely high");
	...
	static ResourceIterator<PotentialOccupantInjuryRatingRel> getRating(final DerivationController _derivation, final Car car) {
		...
		return new IteratorChain<PotentialOccupantInjuryRatingRel>(5) {
			public ResourceIterator<PotentialOccupantInjuryRatingRel> getNextIterator(int pos) {
				switch (pos) {
				case 0:// invoke AE_POIC01: !(_car.getHasAirbags()) ->
						// PotentialOccupantInjuryRating(_car,"extremely high");
					return getRating_0(_derivation.pop(_derivationlevel), car);

				case 1:// invoke AE_POIC02: _car.getHasDriversAirbag() &
						// !(_car.getHasFrontPassengerAirbag()) &
						// !(_car.getHasSidePanelAirbags()) ->
						// PotentialOccupantInjuryRating(_car,"high");
					return getRating_1(_derivation.pop(_derivationlevel), car);

				case 2:// invoke AE_POIC03: _car.getHasDriversAirbag() &
						// _car.getHasFrontPassengerAirbag() &
						// !(_car.getHasSidePanelAirbags()) ->
						// PotentialOccupantInjuryRating(_car,"moderate");
					return getRating_2(_derivation.pop(_derivationlevel), car);

				case 3:// invoke AE_POIC04: _car.getHasDriversAirbag() &
						// _car.getHasFrontPassengerAirbag() &
						// _car.getHasSidePanelAirbags() ->
						// PotentialOccupantInjuryRating(_car,"low");
					return getRating_3(_derivation.pop(_derivationlevel), car);

				case 4:// invoke AE_POIC05: _car.getIsConvertible() &
						// !(_car.getHasRollBar()) ->
						// PotentialOccupantInjuryRating(_car,"extremely high");
	...
	private static ResourceIterator<PotentialOccupantInjuryRatingRel> getRating_0(final DerivationController _derivation, final Car car) {
		_derivation.log("PotentialOccupantInjuryRating.AE_POIC01", DerivationController.RULE, _annotations_AE_POIC01);
	...
	private static ResourceIterator<PotentialOccupantInjuryRatingRel> getRating_1(final DerivationController _derivation, final Car car) {
		_derivation.log("PotentialOccupantInjuryRating.AE_POIC02", DerivationController.RULE, _annotations_AE_POIC02);
		...
		// !(_car.getHasSidePanelAirbags()) ->
		// PotentialOccupantInjuryRating(_car,"high");
		// prereqs: [_car.getHasDriversAirbag(),
		// !(_car.getHasFrontPassengerAirbag()),
		// !(_car.getHasSidePanelAirbags())]
		class _Bindings {
			private org.mandarax.examples.userv.domain.Car _car = car;
		...
		// case 4
		if (!(_bindings._car.hasDriversAirbag())) {
			return EmptyIterator.DEFAULT;
		}
		...
		// case 4
		if (!(!(_bindings._car.hasFrontPassengerAirbag()))) {
			return EmptyIterator.DEFAULT;
		}
		...
		// case 4
		if (!(!(_bindings._car.hasSidePanelAirbags()))) {
			return EmptyIterator.DEFAULT;
		}
	...
	private static ResourceIterator<PotentialOccupantInjuryRatingRel> getRating_2(final DerivationController _derivation, final Car car) {
		_derivation.log("PotentialOccupantInjuryRating.AE_POIC03", DerivationController.RULE, _annotations_AE_POIC03);
	...
	private static ResourceIterator<PotentialOccupantInjuryRatingRel> getRating_3(final DerivationController _derivation, final Car car) {
		_derivation.log("PotentialOccupantInjuryRating.AE_POIC04", DerivationController.RULE, _annotations_AE_POIC04);
	...
	private static ResourceIterator<PotentialOccupantInjuryRatingRel> getRating_4(final DerivationController _derivation, final Car car) {
		_derivation.log("PotentialOccupantInjuryRating.AE_POIC05", DerivationController.RULE, _annotations_AE_POIC05);
		...
		// case 4
		if (!(_bindings._car.isConvertible())) {
			return EmptyIterator.DEFAULT;
		}
