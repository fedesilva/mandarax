...
public class GrandFatherRelInstances {
	...
	// rule: rule1: Father(x,y) & Father(y,z) ->
	...
	private static ResourceIterator<GrandFatherRel> getGrandChildren_0(final DerivationController _derivation, final String grandFather) {
		...
		_derivation.log("test.org.mandarax.compiler.reldef12.GrandFather.rule1", DerivationController.RULE, _annotations_rule1);

		// utility class used to keep track of variables bindings
		// rule: rule1: Father(x,y) & Father(y,z) & __t0==(x.getName()) ->
		// GrandFather(__t0,z.getName());
