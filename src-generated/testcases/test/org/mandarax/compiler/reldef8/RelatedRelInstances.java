 ...
 * 
 * @version Oct 29, 2010 2:37:46 PM
 */
public class RelatedRelInstances {
	...
	// rule: _GrandFather_extends_Related: GrandFather(_x0,_x1) ->
	// Related(_x0,_x1);
	...
	static {
		...
		// relationship annotations for rule _Father_extends_Related:
		// Father(_x0,_x1) -> Related(_x0,_x1);

		// rule annotations for rule _Father_extends_Related: Father(_x0,_x1) ->
		// Related(_x0,_x1);

		// relationship annotations for rule _GrandFather_extends_Related:
		// GrandFather(_x0,_x1) -> Related(_x0,_x1);

		// rule annotations for rule _GrandFather_extends_Related:
		// GrandFather(_x0,_x1) -> Related(_x0,_x1);
	...
	static ResourceIterator<RelatedRel> getRelated1(final DerivationController _derivation, final String person1) {
		...
		return new IteratorChain<RelatedRel>(3) {
			...
			public ResourceIterator<RelatedRel> getNextIterator(int pos) {
				...
				case 1: {
					// invoke _Father_extends_Related: Father(_x0,_x1) ->
					// Related(_x0,_x1);
					return getRelated1_1(_derivation.pop(_derivationlevel), person1);
				}

				case 2: {
					// invoke _GrandFather_extends_Related: GrandFather(_x0,_x1)
					// -> Related(_x0,_x1);
	...
	private static ResourceIterator<RelatedRel> getRelated1_1(final DerivationController _derivation, final String person1) {
		...
		class _Bindings {
			private java.lang.String _x0 = person1; // term _x0
			private java.lang.String _x1 = null; // term _x1
		}
	...
	private static ResourceIterator<RelatedRel> getRelated2_1(final DerivationController _derivation, final String person2) {
		...
		// utility class used to keep track of variables bindings
		class _Bindings {
			private java.lang.String _x0 = null; // term _x0
			private java.lang.String _x1 = person2; // term _x1
		}
		final _Bindings _bindings = new _Bindings();
