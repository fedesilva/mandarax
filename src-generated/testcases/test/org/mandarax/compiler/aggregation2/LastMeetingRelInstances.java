...
public class LastMeetingRelInstances {
	...
	static {
		// relationship annotations for rule rule1: -> LastMeeting(v,max t in
		// Meeting(v,t));

		// rule annotations for rule rule1: -> LastMeeting(v,max t in
		// Meeting(v,t));
	...
	private static ResourceIterator<LastMeetingRel> getLastMeeting_0(final DerivationController _derivation, final String venue) {
		...
		_derivation.log("test.org.mandarax.compiler.aggregation2.LastMeeting.rule1", DerivationController.RULE, _annotations_rule1);

		// utility class used to keep track of variables bindings
		// rule: rule1: ->
		// LastMeeting(v,_max_0(MeetingRelInstances.getMeetings(v)));
		// prereqs: []
		class _Bindings {
