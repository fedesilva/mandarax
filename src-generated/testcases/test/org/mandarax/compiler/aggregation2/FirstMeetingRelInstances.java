...
public class FirstMeetingRelInstances {
	...
	static {
		// relationship annotations for rule rule1: -> FirstMeeting(v,min t in
		// Meeting(v,t));

		// rule annotations for rule rule1: -> FirstMeeting(v,min t in
		// Meeting(v,t));
	...
	private static ResourceIterator<FirstMeetingRel> getFirstMeeting_0(final DerivationController _derivation, final String venue) {
		...
		// rule: rule1: ->
		// FirstMeeting(v,_min_0(MeetingRelInstances.getMeetings(v)));
		// prereqs: []
		class _Bindings {
